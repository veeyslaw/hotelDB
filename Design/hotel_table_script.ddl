...
ALTER TABLE apartment_description ADD CONSTRAINT apart_desc_pk PRIMARY KEY ( apart_desc_id );
...
ALTER TABLE apartment
    ADD CONSTRAINT apartment_apart_desc_fk FOREIGN KEY ( apart_desc_id )
...
CREATE SEQUENCE apart_apart_id_seq START WITH 1 MAXVALUE 99 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER apart_apart_id_trg BEFORE
    INSERT ON apartment
    FOR EACH ROW
    WHEN ( new.apart_id IS NULL )
BEGIN
    :new.apart_id := apart_apart_id_seq.nextval;
END;
/

CREATE SEQUENCE apart_desc_apart_desc_id_seq START WITH 1 MAXVALUE 99 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER apart_desc_apart_desc_id_trg BEFORE
    INSERT ON apartment_description
    FOR EACH ROW
    WHEN ( new.apart_desc_id IS NULL )
BEGIN
    :new.apart_desc_id := apart_desc_apart_desc_id_seq.nextval;
END;
/
...
CREATE SEQUENCE hotel_desc_hotel_desc_id_seq START WITH 1 MAXVALUE 99 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER hotel_desc_hotel_desc_id_trg BEFORE
    INSERT ON hotel_description
    FOR EACH ROW
    WHEN ( new.hotel_desc_id IS NULL )
BEGIN
    :new.hotel_desc_id := hotel_desc_hotel_desc_id_seq.nextval;
END;
/
