...
ALTER TABLE apartment ADD CONSTRAINT apartment_pk PRIMARY KEY ( hotel_id,
                                                                apart_number );
...
ALTER TABLE apartment_description ADD CONSTRAINT apart_desc_pk PRIMARY KEY ( hotel_id,
                                                                             apart_number );
...
ALTER TABLE booking
    ADD CONSTRAINT booking_pk PRIMARY KEY ( hotel_id,
                                            apart_number,
                                            check_in );
...
ALTER TABLE apartment_description
    ADD CONSTRAINT apartment_desc_apartment_fk FOREIGN KEY ( hotel_id,
                                                             apart_number )
...
ALTER TABLE booking
    ADD CONSTRAINT booking_apartment_fk FOREIGN KEY ( hotel_id,
                                                      apart_number )
        REFERENCES apartment ( hotel_id,
                               apart_number );
